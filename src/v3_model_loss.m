function [totalLoss, components] = v3_model_loss(model, task, params, noise)
    n = params.model.numCorticalUnits;
    state = repmat(model.baselineRates, 1, task.numTrials);
    if noise.enabled
    ...
    weights = params.training;
    totalLoss = ...
        weights.preGoPositionLossWeight * components.preGoPosition + ...
        weights.preGoVelocityLossWeight * components.preGoVelocity + ...
        weights.latePreGoVelocityLossWeight * ...
        components.latePreGoVelocity + ...
        weights.endpointUrgencyLossWeight * components.endpointUrgency + ...
        weights.terminalPositionLossWeight * components.terminalPosition + ...
        weights.terminalVelocityLossWeight * components.terminalVelocity + ...
        weights.holdPositionLossWeight * components.holdPosition + ...
        weights.holdVelocityLossWeight * components.holdVelocity + ...
        weights.velocityEffortLossWeight * components.velocityEffort + ...
        weights.activityRegularization * components.activity + ...
        weights.weightRegularization * components.weight;
end
